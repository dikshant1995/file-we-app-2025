...
if os.path.exists(video_path):
    ...
    try:
        ...
        # Extract audio with 16000Hz, mono (1 channel) for compatibility with speech models
        clip.audio.write_audiofile(output_audio_path, fps=16000, nbytes=2, codec='pcm_s16le', ffmpeg_params=["-ac", "1"])
