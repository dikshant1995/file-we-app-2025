    ...
    return (
        <div className="admin-location-selector">
            <div className="selector-label">
                ...
                <span className="text">Policy Location Context:</span>
            </div>
            ...
            <div className="selector-controls">
                ...
                >
                    <option value="">All India (National Default)</option>
                ...
                {(selectedState || selectedCity) && (
                    <button className="btn-reset-location" onClick={handleReset} title="Reset to All India Default">
                        ✕
                    </button>
                )}
            </div>
            ...
            <div className="selector-indicator">
                {selectedState ? (
                    ...
                    <span className="status-badge default">
                        Viewing <strong>National Defaults (All India)</strong>
                    </span>
                )}
            </div>
        </div>
